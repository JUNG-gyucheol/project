...
<%
    ...
    productBean.setProductColor(color);

    int result1 = productDAO.productRegistry(productBean);
    if(result1 == 1) {
        if (mainCategory.equals("top")) {
            ...
            result1 = productDAO.insertTop(productSizeBean);
            out.println(result1);
            ...
            result1 = productDAO.insertBottom(bottomSizeBean);
            out.println(result1);
            ...
            result1 = productDAO.insertShoes(shoesBean);
            out.println(result1);
        }
    } else {
        out.println(0);
