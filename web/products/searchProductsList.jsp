...
<head>
    ...
    <link rel="stylesheet" href="css/searchProductsList.css">
...
<div id="maincon svar">
    <div class="maincon1">
        <div class="allList">
            <div class="allList1">SEARCH</div>
            <div class="allList2">SEARCH LIST</div>
            <hr>
            <div class="allList3">검색상품</div>
            <c:if test="${count != 0}">
            ...
            <c:forEach var="list" items="${list}">
                <div id="con">
                    <div class="allListthumb">
                        <div><a class="a1"
                                href="memberProductViewPro.jsp?productNum=${list.productNum}">${fn:substringBefore(list.thumbnail,"style")}</a>
                        </div>
                    </div>
                    <div class="allListSub">
                        <div><a class="a2"
                                href="memberProductViewPro.jsp?productNum=${list.productNum}">${list.productName}</a>
                        </div>
